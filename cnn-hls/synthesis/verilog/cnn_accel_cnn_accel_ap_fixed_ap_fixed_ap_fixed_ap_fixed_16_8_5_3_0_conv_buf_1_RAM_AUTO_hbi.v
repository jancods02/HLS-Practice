...
`timescale 1ns/1ps
module cnn_accel_cnn_accel_ap_fixed_ap_fixed_ap_fixed_ap_fixed_16_8_5_3_0_conv_buf_1_RAM_AUTO_hbi
#(parameter
    DataWidth    = 15,
    AddressRange = 338,
    AddressWidth = 9,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        cnn_accel_cnn_accel_ap_fixed_ap_fixed_ap_fixed_ap_fixed_16_8_5_3_0_conv_buf_1_RAM_AUTO_hbi_memcore cnn_accel_cnn_accel_ap_fixed_ap_fixed_ap_fixed_ap_fixed_16_8_5_3_0_conv_buf_1_RAM_AUTO_hbi_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
