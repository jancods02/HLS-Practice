...
`timescale 1ns/1ps
module cnn_accel_p_ZZ9cnn_accelP8ap_fixedILi16ELi8EL9ap_q_mode5EL9ap_o_mode3ELi0EES3_S3_S3_E9ibkb
#(parameter
    DataWidth    = 16,
    AddressRange = 140,
    AddressWidth = 8,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        cnn_accel_p_ZZ9cnn_accelP8ap_fixedILi16ELi8EL9ap_q_mode5EL9ap_o_mode3ELi0EES3_S3_S3_E9ibkb_memcore cnn_accel_p_ZZ9cnn_accelP8ap_fixedILi16ELi8EL9ap_q_mode5EL9ap_o_mode3ELi0EES3_S3_S3_E9ibkb_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
