...
module debug_fifo_Loop_VITIS_LOOP_25_2_proc_Pipeline_VITIS_LOOP_25_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] fifo_stream_read_reg_135;
reg    ap_block_pp0_stage0_01001_grp1;
reg   [30:0] i_fu_50;
wire   [30:0] add_ln25_fu_102_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
wire    ap_block_pp0_stage0;
wire   [31:0] zext_ln25_fu_92_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln25_fu_96_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln25_fu_96_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fifo_stream_read = 1'b1;
    end else begin
        fifo_stream_read = 1'b0;
    end
end
...
assign add_ln25_fu_102_p2 = (ap_sig_allocacmp_i_load + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = ((fifo_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((fifo_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((fifo_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((fifo_stream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign icmp_ln25_fu_96_p2 = (($signed(zext_ln25_fu_92_p1) < $signed(size_load)) ? 1'b1 : 1'b0);
...
assign m_axi_gmem1_0_WDATA = fifo_stream_read_reg_135;
...
assign zext_ln25_fu_92_p1 = ap_sig_allocacmp_i_load;

endmodule //debug_fifo_Loop_VITIS_LOOP_25_2_proc_Pipeline_VITIS_LOOP_25_2
